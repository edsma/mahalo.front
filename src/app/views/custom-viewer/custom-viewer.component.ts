...
@Component({
  ...
  styleUrls: ['./custom-viewer.component.scss']
})
export class CustomViewerComponent implements AfterViewInit {

  @Input() params!: ParamsCustomViewer;
  ...
  constructor(public viewerDataService: ViewerDataService,
